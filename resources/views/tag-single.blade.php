    ...
    <div class="row">
      <div class="col-lg-12 text-center">
        ...
        <ul class="list-inline breadcrumb-menu mb-3">
          ...
          <li class="list-inline-item">• &nbsp; <a href='/qurno/tag-single'><span>Lifestyle</span></a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="col-lg-6">
      <article class="card post-card h-100 border-0 bg-transparent">
        <div class="card-body">
          ...
          <a class='d-block' href='/qurno/blog-single' title='Why developers are so divided over WordPress'><h3 class="mb-3 post-title">
    ...
    <div class="col-lg-6">
      <article class="card post-card h-100 border-0 bg-transparent">
        <div class="card-body">
          ...
          <a class='d-block' href='/qurno/blog-single' title='Gig startups want you to believe they can replace your job — don’t fall for it'><h3 class="mb-3 post-title">
